...
/**
* @param {Uint16Array} inputs
* @returns {Uint16Array}
*/
export function reachable(inputs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray16ToWasm0(inputs, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.reachable(retptr, ptr0, len0);
...
* @returns {(string)[]}
*/
export function computations(inputs, target) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray16ToWasm0(inputs, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.computations(retptr, ptr0, len0, target);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('countdown_bg.wasm', import.meta.url);
    }
    const imports = getImports();
